const FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSf70NNLny_dvRKzia_2QTxnr_CUpdsrxbv_W-RR74XfqH9BHQ/viewform?usp=dialog";
  ...
  return (
    <section id="contact" className="px-5 md:px-10 py-24 max-w-[900px] mx-auto">
      ...
      <p className="text-[15px] text-text-warm leading-[1.75] mb-10 max-w-[500px]">
        Fill out our interest form and one of us will reach out within 24 hours to set up a free intro session. No pressure — just a conversation about your goals.
      </p>
      ...
      <div className="bg-white rounded-2xl border border-[#EDE5DC] shadow-[0_4px_24px_rgba(42,26,16,0.06)] px-8 py-10 max-w-[480px]">
        ...
        <a
          ...
          className="block w-full text-center py-[14px] text-[15px] font-bold text-white bg-primary rounded-[10px] tracking-[-0.2px] shadow-[0_4px_16px_rgba(139,26,26,0.25)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_6px_24px_rgba(139,26,26,0.35)]"
